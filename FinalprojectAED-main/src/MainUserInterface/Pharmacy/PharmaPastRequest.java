 ...
 * @author indian
 */
public class PharmaPastRequest extends javax.swing.JPanel {
    ...
    public PharmaPastRequest(JPanel userProcessContainer, User account, Patient p,Ecosystem ecoSystem) {
        initComponents();
