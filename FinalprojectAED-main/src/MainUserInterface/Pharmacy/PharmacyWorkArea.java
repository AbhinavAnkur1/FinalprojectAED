...
public class PharmacyWorkArea extends javax.swing.JPanel {
    ...
    public PharmacyWorkArea(JPanel userProcessContainer, User account, Ecosystem business) {
        initComponents();
    ...
    private void viewReqBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewReqBtnActionPerformed
        ...
        else 
        {
            ...
            PharmaRequestedTests doctorRequestLabTestJPanel = new PharmaRequestedTests(userProcessContainer, userAccount,patient,ecosystem);
    ...
    private void viewReqBtn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewReqBtn2ActionPerformed
        ...
        else 
        {
            ...
            PharmaPastRequest doctorRequestLabTestJPanel = new PharmaPastRequest(userProcessContainer, userAccount,patient,ecosystem);
