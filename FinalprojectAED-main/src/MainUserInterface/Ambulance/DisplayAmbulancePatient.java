...
import MainUserInterface.ReceptionRole.PatientUpdate;

/**
 *
 * @author daddy
 */
public class DisplayAmbulancePatient extends javax.swing.JPanel {

    /**
     * Creates new form DisplayAmbulancePatient
     */
    private final JPanel userProcessContainer;
    private final Ecosystem ecoSystem;
    private User userAccount;

    public DisplayAmbulancePatient(JPanel userProcessContainer, User account, Ecosystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        AmbulanceTable.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        add(currentPatBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 550, 140, 30));
    ...
    private void currentPatBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_currentPatBtnActionPerformed
        ...
        if (selectedRowIndex < 0) {
            ...
            if (ambulance.getStatus().toLowerCase().equals("busy")) {
                CurrentPatientInformation currentPatientDetailsJPanel = new CurrentPatientInformation(userProcessContainer, userAccount, ecoSystem, ambulance);
